...
const PLAN_ICONS: Record<PlanId, React.ReactNode> = {
  ...
  standard: <Zap size={16} className="text-dblue-500" strokeWidth={2} />,
    ...
    <section id="pricing" className="py-24 px-6 bg-canvas">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {(['free', 'standard', 'professional'] as PlanId[]).map((planId, i) => {
                  ...
                  <div className={cn('p-6 flex flex-col flex-1', isHighlighted && 'pt-8')}>
                      ...
                      {plan.features.map((feature) => (
                        <li key={feature} className="flex items-start gap-2.5">
                          <CheckCircle2
                            ...
                            strokeWidth={2}
                          />
                          <span className="text-body-sm text-ink-secondary">{feature}</span>
                        </li>
                      ))}
                    </ul>
                    ...
                    {plan.priceCAD === 0 ? (
                      ...
                      <Link
                        ...
                        className={cn(
                          'w-full flex items-center justify-center px-5 py-3 rounded-card text-body-sm font-semibold focus-ring active:scale-[0.98]',
                          isHighlighted
