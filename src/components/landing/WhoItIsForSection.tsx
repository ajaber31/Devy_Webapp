...
const icons = [
  (
    <svg key="clinician" className="w-7 h-7" viewBox="0 0 28 28" fill="none">
  ...
  (
    <svg key="teacher" className="w-7 h-7" viewBox="0 0 28 28" fill="none">
  ...
  (
    <svg key="parent" className="w-7 h-7" viewBox="0 0 28 28" fill="none">
  ...
  (
    <svg key="teams" className="w-7 h-7" viewBox="0 0 28 28" fill="none">
...
export function WhoItIsForSection({ lang = 'en' }: { lang?: Lang }) {
  const t = getT(lang).landing.whoItsFor

  const personas = [
    { title: t.cliniciansTitle, description: t.cliniciansDesc, useCases: t.clinicianUses, color: 'sage' as const },
    { title: t.teachersTitle, description: t.teachersDesc, useCases: t.teacherUses, color: 'dblue' as const },
    { title: t.parentsTitle, description: t.parentsDesc, useCases: t.parentUses, color: 'sand' as const },
    { title: t.teamsTitle, description: t.teamsDesc, useCases: t.teamUses, color: 'neutral' as const },
  ]
