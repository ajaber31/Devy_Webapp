  ...
  return (
    <div className="space-y-8">
      <div className="bg-white rounded-card-lg shadow-card border border-border/50 p-6">
        <h3 className="font-display text-display-sm font-semibold text-ink mb-5">{p.heading}</h3>
        ...
        <div className="flex items-center gap-5 mb-7">
          ...
          <div>
            ...
            <p className="text-body-xs text-ink-tertiary">{roleLabel}</p>
          </div>
        </div>

        <form onSubmit={handleSave} className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            <label htmlFor="profile-name" className="block text-body-sm font-medium text-ink mb-1.5">{p.nameLabel}</label>
            <input
              id="profile-name"
              type="text"
              value={name}
          ...
          <div>
            <label htmlFor="profile-email" className="block text-body-sm font-medium text-ink mb-1.5">{p.emailLabel}</label>
            <input
              id="profile-email"
              type="email"
              value={profile.email}
          ...
          <div className="sm:col-span-2 flex items-center justify-between">
            <div>
              <label className="block text-body-sm font-medium text-ink mb-0.5">{t.admin.userDetail.accountRole}</label>
              <p className="text-body-xs text-ink-tertiary">{roleLabel}</p>
            </div>
            <button
              type="submit"
